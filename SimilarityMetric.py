...
class SimilarityMetric(object):
    ...
    def useFixedImageDynamics(self, originalFixedImage, transformation, direction):
        ...
        (as the transformation of an original fixed image). This method is called
        by the optimizer just after it sets the fixed image. Transformation
        will be an instance of TransformationModel or None if the
        originalMovingImage equals self.movingImage. Direction is either 1
