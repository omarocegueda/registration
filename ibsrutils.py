...
def showRegistrationResultMidSlices(fnameMoving, fnameFixed, fnameAffine=None):
    ...
    ##Worst pair:
        ...
        showRegistrationResultMidSlices('data/IBSR_nifti_stripped/IBSR_16/IBSR_16_ana_strip.nii.gz', 'data/IBSR_nifti_stripped/IBSR_10/IBSR_10_ana_strip.nii.gz', None)
        showRegistrationResultMidSlices('warpedDiff_IBSR_16_ana_strip_IBSR_10_ana_strip.nii.gz', 'data/IBSR_nifti_stripped/IBSR_10/IBSR_10_ana_strip.nii.gz', None)
