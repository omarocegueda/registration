...
def testRegistrationOptimizerMonomodal2D():
    ...
    registrationOptimizer=SymmetricRegistrationOptimizer(fixed, moving, None, None, similarityMetric, updateRule, maxIter)
...
#        fixed=histeq(fixed)
    ...
    if(synthetic):
        ...
        if(os.path.exists(displacementGTName)):
            ...
            #updateRule=UpdateRule.ProjectedComposition()
            registrationOptimizer=SymmetricRegistrationOptimizer(ibsrT1, templateT1, None, None, similarityMetric, updateRule, maxIter)
            registrationOptimizer.optimize()
    ...
    registrationOptimizer=SymmetricRegistrationOptimizer(warpedFixed, moving, None, None, similarityMetric, updateRule, maxIter)
    registrationOptimizer.optimize()
    #######################show results#################################
    displacement=registrationOptimizer.getForward()
    directInverse=registrationOptimizer.getBackward()
