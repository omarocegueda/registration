...
\begin{figure}[ht]
\centering
    \subfloat[]{\label{fig:region2}\includegraphics[width=0.5\linewidth]{./images/R1.png}}
    \subfloat[]{\label{fig:region2}\includegraphics[width=0.5\linewidth]{./images/R2.png}}\\
    \subfloat[]{\label{fig:region2}\includegraphics[width=0.5\linewidth]{./images/R3.png}}
    \subfloat[]{\label{fig:region2}\includegraphics[width=0.5\linewidth]{./images/R4.png}}
